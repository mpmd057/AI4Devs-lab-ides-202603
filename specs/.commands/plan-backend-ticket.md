...
1. Adopt the role of `specs/.agents/backend-developer.md` (or `.cursor/agents/backend-developer.md`).
...
Markdown document at the path `docs/plans/[jira_id]_backend.md` containing the complete implementation details.
