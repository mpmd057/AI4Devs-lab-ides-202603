...
1. Adopt the role of `specs/.agents/frontend-developer.md` (or `.cursor/agents/frontend-developer.md`)
...
Markdown document at the path `docs/plans/[jira_id]_frontend.md` containing the complete implementation details.
