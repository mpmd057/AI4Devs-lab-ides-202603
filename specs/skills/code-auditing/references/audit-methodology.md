...
- **Project docs**: `AGENTS.md`, `README.md`, and `docs/base-standards.mdc` for project-specific guidelines
...
4. **Don't ignore project conventions** - Respect `AGENTS.md` and `docs/base-standards.mdc` guidelines
