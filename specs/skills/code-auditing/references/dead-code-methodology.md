...
Use your project's configured dead-code tool (for example `knip`, `ts-prune`, or a repo script under `scripts/`). Example:

```bash
# Example only — replace with the command your repository documents
npx knip --reporter json
```
